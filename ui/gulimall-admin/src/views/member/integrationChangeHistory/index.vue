...
<script>
import { listIntegrationChangeHistory, getIntegrationChangeHistory, delIntegrationChangeHistory, addIntegrationChangeHistory, updateIntegrationChangeHistory } from "@/api/member/integrationChangeHistory";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listIntegrationChangeHistory(this.queryParams).then(response => {
        this.integrationChangeHistoryList = response.rows;
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('member/integrationChangeHistory/export', {
        ...this.queryParams
      }, `integrationChangeHistory_${new Date().getTime()}.xlsx`)
    }
  }
};
</script>
