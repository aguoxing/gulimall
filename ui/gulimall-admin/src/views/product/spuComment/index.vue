...
<script>
import { listSpuComment, getSpuComment, delSpuComment, addSpuComment, updateSpuComment } from "@/api/product/spuComment";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listSpuComment(this.queryParams).then(response => {
        this.spuCommentList = response.rows;
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('product/spuComment/export', {
        ...this.queryParams
