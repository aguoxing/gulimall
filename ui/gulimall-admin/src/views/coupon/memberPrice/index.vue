...
<script>
import { listMemberPrice, getMemberPrice, delMemberPrice, addMemberPrice, updateMemberPrice } from "@/api/coupon/memberPrice";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('coupon/memberPrice/export', {
        ...this.queryParams
      }, `memberPrice_${new Date().getTime()}.xlsx`)
    }
  }
};
</script>
