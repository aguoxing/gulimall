...
public class CouponSpuCategoryRelationController extends BaseController {
     ...
     * 获取优惠券分类关联详细信息
     */
    @RequiresPermissions("coupon:couponSpuCategoryRelation:query")
    @GetMapping(value = "/{id}")
     ...
     * 新增优惠券分类关联
     */
    @RequiresPermissions("coupon:couponSpuCategoryRelation:add")
     ...
     * 修改优惠券分类关联
     */
    @RequiresPermissions("coupon:couponSpuCategoryRelation:edit")
     ...
     * 删除优惠券分类关联
     */
    @RequiresPermissions("coupon:couponSpuCategoryRelation:remove")
